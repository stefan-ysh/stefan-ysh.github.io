...
将网站根标签，也就是`html`标签的类名进行更改来达到对应目的，如日间设置为`light`，夜间设置为`dark`，可以进入[`ElementPlus`](https://element-plus.gitee.io/zh-CN/)官网，切换主题时，打开控制台查看`html`类名的变化
